 ...
 * Description:
 */
public class MedicineMineRecyclerAdapter1 extends BaseMultiItemQuickAdapter<MultipleItemEntity,MultipleViewHolder> implements
    ...
    protected MedicineMineRecyclerAdapter1(List<MultipleItemEntity> data, Set<SwipeListLayout> sets) {
        super(data);
        init();
        this.sets=sets;
    }

    public static MedicineMineRecyclerAdapter1 create(List<MultipleItemEntity>data, Set<SwipeListLayout> sets){
        return new MedicineMineRecyclerAdapter1(data,sets);
    }

    public static MedicineMineRecyclerAdapter1 create(DataConverter converter, Set<SwipeListLayout> sets){
        return new MedicineMineRecyclerAdapter1(converter.convert(),sets);
    }
    @Override
            ...
            case ItemType.MEDICINE_MINE:
                ...
                mBtnSupply.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        inputDialog = new InputDialog((Context) Latte.getConfiguration(ConfigKeys.ACTIVITY), "输入补充数量" , "确定",MedicineMineRecyclerAdapter1.this);

...
public class MedicineBoxesMineAdapter extends BaseMultiItemQuickAdapter<MultipleItemEntity,MultipleViewHolder> implements
    ...
    private static final RequestOptions REQUEST_OPTIONS=
            new RequestOptions()
                    ...
                    .dontAnimate();
    public MedicineBoxesMineAdapter(List<MultipleItemEntity> data) {
        super(data);
        init();
    }
    public static  MedicineBoxesMineAdapter create(List<MultipleItemEntity>data){
        return new  MedicineBoxesMineAdapter(data);
    }

    public static  MedicineBoxesMineAdapter create(DataConverter converter){
        return new  MedicineBoxesMineAdapter(converter.convert());
    }
    @Override

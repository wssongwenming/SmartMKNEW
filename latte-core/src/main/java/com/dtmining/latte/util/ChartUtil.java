package com.dtmining.latte.util;
...
class CustomMarkerView extends MarkerView {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        String medicineUseTime=((Reaction)e.getData()).getMedicineUsetime();
        String medicineUseCount=((Reaction)e.getData()).getMedicineUsetime();
        String medicineName=((Reaction)e.getData()).getMedicineName();
        String reaction=((Reaction)e.getData()).getMedicineReaction();
        tvContent.setText(medicineUseTime+"服用:"+medicineName+"状态:"+reaction);
    }
